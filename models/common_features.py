...
class Focus_twoway(nn.Module):
    ...
    def draw_feature(self,features,name):
        for index in range(features.shape[1]):
            ...
            # to [0,255]
            feature = np.round(feature*255).copy()
            print(feature[0])
            # feature=cv2.UMat(feature)
            imgUMat = np.float32(feature)
            # gray = cv2.cvtColor(imgUMat, cv2.COLOR_BGR2GRAY)
            cv2.imwrite(name+str(index)+'.bmp', imgUMat)
    ...
    def forward(self, x):  # x(b,c,w,h) -> y(b,4c,w/2,h/2)
        ...
        self.draw_feature(x2,'featureimg/img_err')
        # x3=torch.cat((x1,x2),dim=1)#64

        x_cat1=torch.cat([x1[..., ::2, ::2], x1[..., 1::2, ::2], x1[..., ::2, 1::2], x1[..., 1::2, 1::2]], 1)#4
        x_cat2=torch.cat([x2[..., ::2, ::2], x2[..., 1::2, ::2], x2[..., ::2, 1::2], x2[..., 1::2, 1::2]], 1)#4
        self.draw_feature(x_cat1,'featureimg/x_cat1')
        self.draw_feature(x_cat2,'featureimg/x_cat2')
        # x_cat3=torch.cat([x3[..., ::2, ::2], x3[..., 1::2, ::2], x3[..., ::2, 1::2], x3[..., 1::2, 1::2]], 1)#8

        x_out1=self.conv4_32_1(x_cat1)#32
        self.draw_feature(x_out1,'featureimg/x_out1')
        x_out2=self.conv4_16_2(x_cat2)#16
        self.draw_feature(x_out2,'featureimg/x_out2')
        # x_out3=self.conv8_32(x_cat3)#32
        
        x_out2_avg5=self.avgpool_5(x_out2)
        self.draw_feature(x_out2_avg5,'featureimg/x_out2_avg5')
        x_out2_max5=self.maxpool_5(x_out2)
        self.draw_feature(x_out2_max5,'featureimg/x_out2_max5')
        ...
        self.draw_feature(x_out22,'featureimg/x_out22_befor')
        x_out22=self.conv48_32_1(x_out22)#32
        self.draw_feature(x_out22,'featureimg/x_out22_after')
